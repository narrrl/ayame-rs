...
fn create_config_interactive() -> Config {
    ...
    info!("Put in your application id (usually the discord client id of the bot):");
    let application_id: u64 = get_userinput()
        .expect("Couldn't read your input")
        .trim()
        .parse::<u64>()
        .expect("Couldn't parse your application id, should be a number");
